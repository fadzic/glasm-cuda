	...
	{	/*************************************
		...
		*************************************/
		...
		if (a[i].base_algorithm.compare("polarga")==0 || a[i].base_algorithm.compare("\"polarga\"")==0)
		{
			...
			if (a[i].base_algorithm.compare("glasm_cuda")==0 || a[i].base_algorithm.compare("\"glasm_cuda\"")==0)
			{   algorithm[NumAlgorithms].init            = GLASM_CUDA::init;
				algorithm[NumAlgorithms].pre_match       = GLASM_CUDA::pre_match;
				algorithm[NumAlgorithms].match           = GLASM_CUDA::match;
				algorithm[NumAlgorithms].post_match      = GLASM_CUDA::post_match;
				algorithm[NumAlgorithms].deinit          = GLASM_CUDA::deinit;
			}
